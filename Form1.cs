...
namespace sMangaManager
{
    public partial class Form1 : Form
    {
        ...
        {
            textBoxReNameFolder.Text = "C:\\Program-User\\10temp\\06\\temp";
        }
        ...
        private void buttonTest_Click(object sender, EventArgs e)
        {
            ...
            //string txt = get_html_by_request("https://www.toptoon.net/comic/epList/80643/GC", cookie);
            string url = textBoxUrl.Text;
            string dir = textBoxReNameFolder.Text;

            string html = get_html_by_request(url, global.cookie);
